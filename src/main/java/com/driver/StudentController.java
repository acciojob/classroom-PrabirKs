...
public class StudentController {
    ...
    public ResponseEntity<List<String>> getStudentsByTeacherName(@PathVariable String teacher){
        List<String> students = studentService.findStudentOfTeacher(teacher); // Assign list of student by calling service layer method
    ...
    public ResponseEntity<List<String>> getAllStudents(){
        List<String> students = studentService.findAllStudent(); // Assign list of student by calling service layer method
